...
botonClick.addEventListener("click",()=>{
    ...
    if (input.value < 300){
        resultado.textContent `Configuracion no disponible`
...
const softwares = [{id :"windows10", valor: 50},
    ...
    function mostrarDatosPc(tier,proces,grafico,rams,discoduro){
        ...
        "Para este presupuesto te vamos a recomendar un pc de tipo"+ " " + tier +" "+ "y va a contener los siguientes componentes:" +  "\n" +" " + proces + " " + "\n" + " "  + grafico + " " + "\n" + " "  + rams + " " + "\n" + " "  + discoduro;
        return;
        }
